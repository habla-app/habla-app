...
> Última actualización: 19 de Abril 2026 (Hotfix post-Sub-Sprint 5: NavBar links visibles por default, CTA "Crear combinada" abre el modal directo desde /matches, limpieza de copy obsoleto de Sub-Sprints en UI pública)
