...
> Última actualización: 30 Apr 2026 — Lote B cerrado (capa pública mobile-first: layout unificado público↔autenticado con BottomNav v3.1, /partidos/[slug] reescrito con CTAs jerárquicos + pick Premium bloqueado + cross-link a Liga Habla!, /cuotas mobile-first, refactor visual de casas/blog/guias/pronosticos/auth/suscribir/faq/legal, eliminación de /(main)/page.tsx + /matches consolidados en home única).
