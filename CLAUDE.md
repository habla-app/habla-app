...
> Última actualización: 19 de Abril 2026 (Hotfix #6 post-Hotfix #5: nueva distribución de premios reemplaza 35/20/12/33 — paga al top 10% con curva top-heavy 45% al 1° + decaimiento geométrico; empates reparten equitativamente los premios de los puestos que ocupan; desempates por marcador/tarjeta/timestamp ELIMINADOS; motor de puntuación proyecta TODOS los campos en vivo incluyendo marcador exacto — antes quedaba en 0 durante EN_VIVO; poller sincroniza eventos con DELETE+INSERT para que goles anulados por VAR desaparezcan de la timeline sin refresh; minuto del partido con TTL extendido 10→30 min + fallback REST cada 45s para que el LiveHero no caiga a "—" en HT largos; countdown de MatchCard se actualiza en vivo vía CountdownLabel (setInterval 1s) — antes quedaba pegado al valor SSR; widget "🏆 Cómo se pagan los premios" en sidebar de /matches; copy motivacional en ranking en vivo con 4 estados según puesto/empate)
