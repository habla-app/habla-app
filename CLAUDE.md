...
> Última actualización: 26 Abr 2026 (Lote 6C-fix3 — sistema de auditoría completo de balances con 13 invariantes + endpoints `/admin/auditoria/full` y `/admin/auditoria/usuario/:id`).
