...
> Última actualización: 19 de Abril 2026 (Hotfix #2 post-Sub-Sprint 5: store de Lukas hidratado desde la sesión + ComboModal con guardia de balance insuficiente, /live-match incluye partidos cuyos torneos no transicionaron, /mis-combinadas protegida por middleware + force-dynamic en páginas autenticadas, helper único `authedFetch` para todos los fetches client-side)
