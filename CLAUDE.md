...
> Última reescritura: 4 May 2026 (Lote 7 — afiliación MINCETUR).
...
| 8 — Editorial + provider MDX | ⏳ | Modelo Articulo/Categoria + CMS interno + provider MDX que registra los componentes del Lote 7 (`<CasaCTA>`, `<CasaReviewCard>`, `<TablaCasas>`, `<DisclaimerLudopatia>`) + render público de artículos. |
