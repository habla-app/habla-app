...
export function LukasPremiosPill({ lukasPremios }: Props) {
  return (
    <div
      className="relative overflow-hidden rounded-md border border-light bg-card px-4 py-4 pl-5 text-center shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
