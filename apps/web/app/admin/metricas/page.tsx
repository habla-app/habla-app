// /admin/metricas — métricas in-house. Lote F (movida desde /admin/dashboard).
//
// Renombrada en Lote F: el dashboard raíz pasa a ser KPIs estratégicos del
// negocio, y las métricas técnicas/funnel quedan acá. Conserva exactamente
// las funciones del Lote 6 (visitas, registros, funnel, top eventos,
// errores 24h, selector de rango).
...
export default async function AdminDashboardMetricasPage({ searchParams }: PageProps) {
  ...
  return (
    <>
      <AdminTopbar
        title="Métricas"
        description="Analytics in-house · Visitas, registros, funnel y top eventos del periodo."
        breadcrumbs={[{ label: "Análisis" }, { label: "Métricas" }]}
