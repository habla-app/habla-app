...
// líneas 1687-1991). Layout 2-col desktop: content (matches list) + sidebar
// sticky (340px) con los 3 widgets. Sub-Sprint 3 construye `/matches` con
// data real api-football y reusa la misma sidebar. Los CTAs del MatchCard
// redirigen a login con `callbackUrl=/` cuando no hay sesión.
  ...
  return (
    <div className="mx-auto w-full max-w-[1280px] px-4 pt-6 md:px-6 md:pt-8">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_340px]">
        ...
        {/* STICKY SIDEBAR — desktop only (lg+). En mobile se renderiza
            debajo del contenido sin sticky. */}
