...
//
// EVENTOS YA INSTRUMENTADOS (Lote 6):
...
//   casa_click_afiliado          // LOTE_8: instrumentar `casa_click_afiliado` cuando se construya /go/[slug] (server-side track antes del redirect, props { slug, casaId })
